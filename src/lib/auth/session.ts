...
/**
 * Validates the session from cookies and returns the session if valid.
...
/**
 * Used in server components or API routes to require authentication.
 */
export async function requireAuth(): Promise<AuthSessionPayload | null> {
